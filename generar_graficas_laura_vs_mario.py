...
CSV_PATH = ROOT / "laura_vs_mario_50_results.csv"
...
summary.to_csv(OUT_DIR / "laura_vs_mario_50_summary.csv", index=False)

# Grafica 14: resultados globales y separados por quien inicia.
fig, axes = plt.subplots(1, 2, figsize=(15, 6))

overall = summary[summary["starter"] == "Todos"].iloc[0]
labels = ["Laura MCTS", "Mario", "Empate"]
values = [overall["laura_wins"], overall["mario_wins"], overall["draws"]]
colors = [COLORS[LAURA_NAME], COLORS[MARIO_NAME], COLORS["Draw"]]
...
fig.suptitle(
    "Grafica 14. Laura vs Mario: resultados alternando inicio",
    fontsize=15,
    fontweight="bold",
)
save(fig, "14_laura_vs_mario_resultados.png")

# Grafica 15: costo computacional y duracion.
fig, axes = plt.subplots(1, 2, figsize=(15, 6))
...
box = axes[0].boxplot(
    data, tick_labels=["Laura MCTS", "Mario"], patch_artist=True
)
for patch, color in zip(box["boxes"], [COLORS[LAURA_NAME], COLORS[MARIO_NAME]]):
...
fig.suptitle("Grafica 15. Laura vs Mario: costo computacional", fontsize=15, fontweight="bold")
save(fig, "15_laura_vs_mario_tiempos.png")
