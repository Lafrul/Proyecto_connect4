...
OUTPUT_PATH = ROOT / "s_vs_mario_50_results.csv"
...
SPolicy = load_class("groups/Group S/policy.py", "group_s_policy_mario_runner", "Winner")
MarioPolicy = load_class(
    "groups/Group mario/policy.py", "group_mario_policy_runner", "Winner"
)
...
def play_one(game_id: int) -> list[dict]:
    ...
    for focal_name, focal_side, focal_color, opponent_name in [
        ...
        rows.append(
            {
                "experiment_id": "S_vs_Mario_alternating_50",
                "match_id": f"S_vs_Mario_game_{game_id:03d}",
                "agent_1": first_name,
                "agent_2": second_name,
