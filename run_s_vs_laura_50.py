...
OUTPUT_PATH = ROOT / "s_vs_laura_50_results.csv"
...
SPolicy = load_class("groups/Group S/policy.py", "group_s_policy_runner", "Winner")
LauraPolicy = load_class(
    "groups/Group laura/policy.py", "group_laura_policy_runner", "MCTSAgent"
)
...
def play_one(game_id: int) -> list[dict]:
    ...
    for focal_name, focal_side, focal_color, opponent_name in [
        ...
        rows.append(
            {
                "experiment_id": "S_vs_Laura_alternating_50",
                "match_id": f"S_vs_Laura_game_{game_id:03d}",
                "agent_1": first_name,
                "agent_2": second_name,
                ...
                "seed": 2026 + game_id,
                "starter": first_name,
                "s_trials": int(getattr(SPolicy, "TRIALS", 0)),
